...
function(a) {
    ...
    list = function() {
        ...
        f = function(a, b) {
            for (var c = 0,
            d = a.length; d > c; c++) if (!b(a[c])) return ! 1;
            return ! 0
        },
        g = function(a, b) {
            return $.inArray(b, a)
    ...
    dom = function() {
        ...
        fa = function(a, b) {
            for (var c = a,
            d = 0,
            e = b.length; e > d; d++) c = c.childNodes.length <= b[d] ? c.childNodes[c.childNodes.length - 1] : c.childNodes[b[d]];
            return c
        },
        ga = function(a, b) {
    ...
    function(a, b) {
        for (var c = [], d = 0, e = b.colors.length; e > d; d++) {
            ...
            g = b.colors[d], h = [], i = 0, j = g.length; j > i; i++) {
                var k = g[i];
    ...
    Editor = function(a) {
        ...
        this.removeBogus = function() {
            ...
            if (a) {
                ...
                c = b.nodeValue.indexOf(dom.ZERO_WIDTH_NBSP_CHAR); - 1 !== c && b.deleteData(c, 1),
        ...
        this.createLink = this.wrapCommand(function(a) {
            ...
            $.each(h,
            function(a, c) {
                b = /^[A-Za-z][A-Za-z0-9+-.]*\:[\/\/]?/.test(b) ? b: "http://" + b,
                $(c).attr("href", b),
    ...
    Statusbar = function(a) {
        ...
        e = a.options;
        this.initialize = function() {
            e.airMode || e.disableResizeEditor || c.on("mousedown",
            function(a) {
                a.preventDefault(),
                a.stopPropagation();
    ...
    Buttons = function(a) {
        ...
        h = this.representShortcut = function(a) {
            var b = g[a];
            return e.shortcuts && b ? (agent.isMac && (b = b.replace("CMD", "鈱�).replace("SHIFT ","鈬�)), b = b.replace("BACKSLASH", "\\").replace("SLASH", "/").replace("LEFTBRACKET", "[").replace("RIGHTBRACKET", "]"), " (" + b + ")") : ""
        };
        this.initialize = function() {
    ...
    HelpDialog = function(a) {
        ...
        this.initialize = function() {
            var a = e.dialogsInBody ? $(document.body) : d,
            b = ['<p class="text-center">', '<a href="http://summernote.org/" target="_blank">Summernote 0.8.2</a> 路 ', '<a href="https://github.com/summernote/summernote" target="_blank">Project</a> 路 ', '<a href="https://github.com/summernote/summernote/issues" target="_blank">Issues</a>', "</p>"].join("");
            this.$dialog = c.dialog({
